   ...
   <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
     <ul class="navbar-nav mr-auto">
         ...
         <li class="nav-item">
             <a class="nav-link" href="search.php?search_category=academics">ACADEMIC BOOKS</a>             
         </li>
         <li class="nav-item">
             <a class="nav-link" href="search.php?search_category=research papers">RESEARCH PAPERS</a>             
         </li>
         <li class="nav-item">
      ...
      <input class="form-control mr-sm-2" type="text" placeholder="User Name" aria-label="User name" NAME="username">
       <input class="form-control mr-sm-2" type="search" placeholder="Password" aria-label="Password" name>
      <button class="btn btn-primary my-2 my-sm-0" type="submit" name="login">Register</button>
    </form>
    ...
    <ul class="list-group" id="tab-list" role="tablist" style="margin-left:0px">
        ...
        <li class="list-group-item"><a href="search.php?search_category=research papers">RESEARCH PAPERS</a></li>
  <li class="list-group-item"><a href="search.php?search_category=novels">NOVELS</a></li>
  <li class="list-group-item"><a href="magazines">MAGAZINES</a></li>
  ...
  <div class="card-body">
    ...
    <h5 class="card-text text-center"><?php echo $the_book_author; ?></h5>
     <h6 class="card-text text-center"><?php echo $the_book_price; ?> Rs.</h6>
       ...
       <button class="btn btn-primary btn-lg" value="hello"><a href="book.php?book_id=<?php  echo $the_book_id; ?>"> Buy it now </a></button>
  </div>
